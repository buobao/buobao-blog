...
public class ResultService {
    ...
    public Result success(){return new Result(1, "Action Success", 0L, (Map)null);}
    public Result error(){return new Result(0,"Action Failed",1L,(Map)null);}

    public Result successWithId(String id){
        HashMap map = new HashMap();
        map.put("id",id);
        return this.build(1,0L,"Action Success",map);
    }

    public Result seccess(String message){return new Result(1, message, 0L,(Map)null);}
    public Result error(String message){return new Result(0,message,1L,(Map)null);}
