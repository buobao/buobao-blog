...
public abstract class BaseServiceImpl<T extends Entity, PK extends Serializable> implements BaseService<T,PK> {
    ...
    public List<T> getList(DetachedCriteria detachedCriteria, List<String> aliasList, String searchDate, Date beginDate, Date endDate, Map<String, Object> params, String orderBy, OrderType orderType) {
        return this.getBaseDao().getList(detachedCriteria, aliasList, searchDate, beginDate, endDate, params, orderBy, orderType);
    }

    public List<T> getList(String searchDate, Date beginDate, Date endDate, Map<String, Object> params, String orderBy, OrderType orderType) {
        return this.getList((DetachedCriteria)null, (List)null, searchDate, beginDate, endDate, params, orderBy, orderType);
    }

    public List<T> getList(Map<String, Object> params, String orderBy, OrderType orderType) {
        return this.getList("", (Date)null, (Date)null, params, orderBy, orderType);
    }

    public List<T> getList(Map<String, Object> params) {
        return this.getList(params, "createDate", OrderType.asc);
    }
    ...
    public Pager findByPager(Pager pager, DetachedCriteria detachedCriteria, List<String> aliasList, String searchDate, Date beginDate, Date endDate, Map<String, Object> params, String orderBy, OrderType orderType) {
    ...
    public Pager findByPager(Pager pager, Map<String, Object> params, String orderBy, OrderType orderType) {
        return this.findByPager(pager, (String)null, (Date)null, (Date)null, (Map)params, (String)orderBy, (OrderType)orderType);
    }

    public Pager findByPager(Pager pager, String searchDate, Date beginDate, Date endDate, Map<String, Object> params, String orderBy, OrderType orderType) {
